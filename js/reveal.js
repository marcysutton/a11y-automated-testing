...
(function( root, factory ) {
    ...
    function resetButtons ( el ) {
      ...
      el.removeAttribute( 'disabled' );
		...
		if( routes.left ) dom.controlsLeft.forEach( function( el ) { resetButtons( el ); } );
		if( routes.right ) dom.controlsRight.forEach( function( el ) { resetButtons( el ); } );
		if( routes.up ) dom.controlsUp.forEach( function( el ) { resetButtons( el );	} );
		if( routes.down ) dom.controlsDown.forEach( function( el ) { resetButtons( el ); } );
